...
cat > "$SETENV" <<EOF
# Generated by scripts/tomcat-run.sh — binds TA data dir for Servlet bootstrap
export TA_DATA_DIR="${TA_DATA_DIR}"
export TA_JWT_SECRET="${TA_JWT_SECRET}"
export CATALINA_OPTS="\${CATALINA_OPTS} -Dta.data.dir=${TA_DATA_DIR}"
EOF
